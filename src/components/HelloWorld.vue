...
<template>
  ...
  <div class="my-2 text-center flex flex-wrap justify-center items-center">
    <el-button @click="count++">d is: {{ count }}</el-button>
    <el-button type="primary" @click="count++">primary is: {{ count }}</el-button>
    <el-button type="success" @click="count++">success is: {{ count }}</el-button>
